...
template <typename T> struct has_type<T, mpark::variant<>> : std::false_type {};
...
struct has_type<T, mpark::variant<U, Ts...>> : has_type<T, mpark::variant<Ts...>> {
};
...
struct has_type<T, mpark::variant<T, Ts...>> : std::true_type {};
